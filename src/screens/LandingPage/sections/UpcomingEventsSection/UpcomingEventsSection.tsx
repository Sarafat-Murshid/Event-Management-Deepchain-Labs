    ...
    <Card className="w-[400px] shadow-[0px_21.77px_54.43px_#7772aa1a] bg-[url(/body.svg)] bg-[100%_100%] overflow-hidden">
      ...
      <CardContent className="p-4">
        <div className="flex items-center gap-[19px] mt-2">
          ...
          <h3 className="text-[23.8px] [font-family:'Geist',Helvetica] font-medium text-[#242565] tracking-[-1.19px] leading-[28.6px] whitespace-nowrap [text-shadow:0px_14.58px_11.53px_#8b60dd21]">
